...
class ConfigManager:
    ...
    def __init__(
        ...
        self.env_path = env_path or Path("config/.env")
    ...
    def get_provider_config(self, provider_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Provider '{provider_name}' 설정 로드 실패: {e}")
            return {}

    def get_all_provider_configs(self) -> Dict[str, Dict[str, Any]]:
        """
        모든 Provider의 설정을 로드합니다.
    ...
    def get_unified_accounts(self) -> List[str]:
        """
        통합 계좌 리스트를 가져옵니다.
